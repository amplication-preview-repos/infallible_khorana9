...
@InputType()
class OrderHistoryCreateNestedManyWithoutOrdersInput {
...
export { OrderHistoryCreateNestedManyWithoutOrdersInput as OrderHistoryCreateNestedManyWithoutOrdersInput };
