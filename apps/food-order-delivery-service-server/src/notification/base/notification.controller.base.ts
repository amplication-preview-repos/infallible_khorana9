...
import { AssignOrderDto } from "../../order/AssignOrderDto";
...
export class NotificationControllerBase {
  ...
  @common.Post("/notifications/newOrderAssignment")
  ...
  async NotifyNewOrderAssignment(
    @common.Body()
    body: AssignOrderDto
  ): Promise<string> {
    return this.service.NotifyNewOrderAssignment(body);
  }
}
